...
#define STRING_CONFIG_H_AUTHOR "Jess Sullivan @ the D&M Makerspace" // Who made the changes.
...
#define CUSTOM_PRINTER_NAME "Nemo is"
...
// Jess: using standard, unsheathed EPCOS (1) instead of sheathed semitec (5)
