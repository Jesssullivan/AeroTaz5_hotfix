  ...
  #define TEMP_BED_PIN       14   // ANALOG NUMBERING
    ...
    #define SERVO0_PIN         11
      ...
      #define LCD_PINS_D7 29
        ...
        #define BEEPER_PIN_PIN 33  // BEEPER_PIN_PIN on AUX-4
      ...
      #define BEEPER_PIN_PIN_PIN 33		//No BEEPER_PIN_PIN_PIN added
